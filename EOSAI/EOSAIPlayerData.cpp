...
CPlayerData::CPlayerData( long iPlayer, long iAIBrainIntelligence )
{
	ASSERT( false );

	m_iPlayer = iPlayer;
	m_iAIBrainIntelligence = iAIBrainIntelligence;
	...
	*/
	...
	//
		...
		if( iAIBrainIntelligence == 1 ) m_fAICheat_FreeResearchPoints = -2.0f; // this is a penalty
		if( iAIBrainIntelligence == 2 ) m_fAICheat_FreeResearchPoints = +0.0f;
		if( iAIBrainIntelligence == 3 ) m_fAICheat_FreeResearchPoints = +2.5f;
...
void  CPlayerData::Serialize( CEOSAISerial* pSerial )
{
	char iVersion = 4;
...
void  CPlayerData::Deserialize( CEOSAISerial* pSerial )
{
	char iVersion = 0;
