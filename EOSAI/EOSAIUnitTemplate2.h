...
{
	//public:
		//CEOSAIUnitTemplate2( CUnitTemplate* pUnitTemplate );
...
class DLLIMPEXP CEOSAIUnitTemplate2
{
	public:
		//
		...
		//
			...
			CEOSAIUnitTemplate2( EOSAI::CGameRules* pAIGameRules );
			~CEOSAIUnitTemplate2();
	...
	//		long           GetDefaultRotation();
		...
		//
			...
			//
			CEOSAIUnitTemplate2* GetUpgradesFrom(); // this doesn't always work right since multiple units can upgrade to this one
		...
		//
			...
			//CEOSAIStringAndLongSet*  GetTargetPriorityTags(){ return &m_TargetPriorityTagSet; }
		...
		//
			...
			CEOSAIStringAndFloat* GetProductionAndConsumptionPerTurnObj( CString strResource );
			void  RemoveProductionAndConsumptionPerTurn( CString strResource );
			CList< CEOSAIStringAndFloat* >*  GetProductionAndConsumptionPerTurnList(){ return &m_ProductionAndConsumptionPerTurnList; }
			...
			CEOSAIStringAndFloat* GetProductionAndConsumptionPerMoveObj( CString strResource );
			void  RemoveProductionAndConsumptionPerMove( CString strResource );
			CList< CEOSAIStringAndFloat* >*  GetProductionAndConsumptionPerMoveList(){ return &m_ProductionAndConsumptionPerMoveList; }
		...
		//
			...
			bool  CanContain( CEOSAIPoiObject2* pPoi );
			bool  CanContain( CEOSAIUnitTemplate2* pTemplate );
		...
		//	float GetViewRange( CString strUnitTag, bool bUseUnitDefaults );
			float GetViewRange( CEOSAIPoiObject2* pPoi );
			float GetViewRange( CEOSAIUnitTemplate2* pUnitTemplate );
		...
		//
			...
			bool  CanAttack( CEOSAIPoiObject2* pTarget );
			...
			bool  OneAttackPerLandingVs( CEOSAIPoiObject2* pTarget );
			//
			...
			bool  CanCapture( CEOSAIPoiObject2* pTarget );
			bool  CanDegrade( CEOSAIPoiObject2* pTarget );
			bool  CanDestroy( CEOSAIPoiObject2* pTarget );
		...
		//	CUnitTemplateCombatAnimationDesc* GetUnitTemplateCombatAnimation( CPoi* pTarget );
			...
			CEOSAIAttackVs2* GetAttackVs( CEOSAIPoiObject2* pTarget, bool bIsLandedOrDocked = false );
			CEOSAIAttackVs2* GetAttackVsCombatUnitType( long iCombatUnitType );
			//CEOSAIAttackVs2* GetAttackVs( CString strCombatUnitType );
			CEOSAIAttackVs2* GetAttackVs( EnumAIPoiObjectType ePoiObjectType, CEOSAIUnitTemplate2* pTargetUnitTemplate, bool bIsLandedOrDocked );
			//CEOSAIAttackVs2* GetAttackVs( EnumPoiObjectType eUnitType );
			CList< CEOSAIAttackVs2* >*  GetAttackVsList(){ return &m_AttackVsList; }
			// Attack To-Hit
			float  GetAttackToHitVs( EnumAIPoiObjectType ePoiObjectType, CEOSAIUnitTemplate2* pTargetUnitTemplate, bool bIsLandedOrDocked );
			//float  GetAttackToHitVs( CPoiObject* pPoiObject, Enum_Prone eDefendersProneState );
			float  GetAttackToHitVs( CEOSAIPoiObject2* pPoiObject, bool bIsLandedOrDocked );
			float  GetAttackToHitVs( CEOSAIUnitTemplate2* pTarget );
			...
			long   GetAttackDamageVs( CEOSAIPoiObject2* pTarget, bool bIsLandedOrDocked );
			long   GetAttackDamageVs( CEOSAIUnitTemplate2* pTarget );
			long   GetAttackDamageVs( long iTargetCombatUnitType );
			//long   GetAttackDamageVs( CString strTargetCombatUnitType );
			// Range
			float  GetAttackRangeVs( CEOSAIUnitTemplate2* pTarget );
	...
	//		CEOSAIAttackVs2* GetAttackVsSubmarine(){ return GetAttackVs( "Submarine" ); }
		...
		//
			...
			CEOSAIJobCapability*  GetAIJobCapability(){ ASSERT( false ); return &m_AIJobCapability; } // need to calculate this
			void   GetAIJobCapability( CEOSAIJobCapability* pAIJobCapability );
			...
			float GetExpectedHPDamage( CEOSAIUnitTemplate2* pTarget );
			...
			CEOSAIStringAndFloatSet  GetCombatPowerVsUnitTypes();
	...
	protected:
		...
		//
			//CUnitsubsetPermission  m_AllowUnitsubset;
		//
		// Unit Type
		//
			// Type
		...
		//	float m_fOilConsumption;
			CList< CEOSAIStringAndFloat* >  m_ProductionAndConsumptionPerTurnList;
			CList< CEOSAIStringAndFloat* >  m_ProductionAndConsumptionPerMoveList;
	...
	//	EnumSpecialUnitSymbol  m_eSpecialUnitSymbol;
		...
		//
			//CEOSAIStringAndLongSet  m_TargetPriorityTagSet;
		//
			long  m_iNumValue;
};
