...
//class DLLIMPEXP CPlayerData // : public EOSAI::CAIPlayer2Base
class DLLIMPEXP CPlayerData // : public EOSAI::CAIPlayer2Base
{
	public:
		enum EnumState
	...
	public:
		CPlayerData( long iPlayer, long iAIBrainIntelligence );
		virtual ~CPlayerData(){}

		//void SetPlayerNumber( long i ){ m_iPlayerNumber = i; }
		long GetPlayerNumber(){ return m_iPlayer; }

		// Functions inherited from EOSAI::CAIPlayer2Interface:
...
*/
		...
		//	void Incoming_IMailResponse( long iIMailId, long iPlayer, EOSAIEnumMailResponse eResponse );
			// Trade Agreements
...
*/
	...
	//
		...
		//
			long  m_iNextAIMailId;  // this is for legacy reasons only
