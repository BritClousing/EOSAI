...
class DLLIMPEXP CEOSAIUnitTemplateSet
{
	public:
	...
	public:
		...
		//
		//
		void  AddUnitTemplate( CEOSAIUnitTemplate* pAIUnitTemplate );
		void  AddUnitTemplate_Unsafe( CEOSAIUnitTemplate* pAIUnitTemplate ){ m_List.AddTail( pAIUnitTemplate ); }
		//
		void  Set( CEOSAIUnitTemplateSet* pOtherSet );
		void  SetToUsefulUnits( CEOSAIJobsToDo& Jobs, CEOSAIUnitTemplateSet* pOtherSet );
		void  operator=( CEOSAIUnitTemplateSet& Other ){ Set( &Other ); }
		//
		void  Add( CEOSAIUnitTemplateSet* pOtherSet );
		void  Add( EnumUnitTemplateFilter eFilter, CEOSAIUnitTemplateSet* pOtherSet );
		void  AddUsefulUnits( CEOSAIJobsToDo& Jobs, CEOSAIUnitTemplateSet* pOtherSet );
		//	
		void  OutputSets( EnumUnitTemplateFilter eFilter, CEOSAIUnitTemplateSet* pOutPrimaryUnits, CEOSAIUnitTemplateSet* pOutTransports = NULL );
		//void  OutputSets( CEOSAIJobsToDo& Jobs, CList< CEOSAIUnitTemplateSet* >* pUnitTemplateSets );
		void  GetTransports( CEOSAIUnitTemplate* pTraveller, CEOSAIUnitTemplateSet* pOutTransports );
		...
		//
			...
			CList< CEOSAIUnitTemplate* >  m_List;
		...
		//
		//
			float GetFastestTransportMovementRate( CEOSAIUnitTemplate* pTransportee );
			float GetFastestSeaTransportMovementRate( CEOSAIUnitTemplate* pTransportee );
		...
		//
			...
			*/
			...
			//void GetAttritionCostVs( CEOSAIUnitTemplate* pTarget, CUnitTemplateAndFloatSet* pResults );
		//
		...
		//
			EOSAI::StringAndFloatSet*  GetHighestHPDefenseDivCost_UnitTypeSet(){ UpdateSummaryInformation(); return &HighestHPDefenseDivCost_UnitTypeSet; }
		...
		//
			...
			EOSAI::StringAndFloatSet  HighestHPDefenseDivCost_UnitTypeSet; // 
};
