...
CEOSAIUnitTemplate2::CEOSAIUnit2Template( CUnitTemplate* pUnitTemplate )
{
...
#include "EOSAIResource2.h"
#include "EOSAIFortification.h"
#include "EOSAIAirfield2.h"
...
CEOSAIUnitTemplate2::CEOSAIUnitTemplate2( EOSAI::CGameRules* pAIGameRules )
{
...
CEOSAIUnitTemplate2::~CEOSAIUnitTemplate2()
{
...
void  CEOSAIUnitTemplate2::Serialize( CEOSAISerial* pSerial )
{
	long iCount;
...
//		pSerial->Serialize( m_fRadarRange );
	...
	//
		...
		while( pos )
		{
			CEOSAIStringAndFloat* pStringAndFloat = m_ProductionAndConsumptionPerTurnList.GetNext( pos );
		...
		while( pos )
		{
			CEOSAIStringAndFloat* pStringAndFloat = m_ProductionAndConsumptionPerMoveList.GetNext( pos );
			pSerial->SerializeUnicode( pStringAndFloat->m_strValue );
			pSerial->Serialize( pStringAndFloat->m_fValue );
		}
...
*/
void  CEOSAIUnitTemplate2::InvokeUnitsubsetUpgradeTo( CString strUnitsubset, CString strUpgradeTo )
{
...
CString CEOSAIUnitTemplate2::GetUnitsubsetUpgradeTo( CString strUnitsubset )
{
	POSITION pos = m_UpgradeToList.GetHeadPosition();
	while( pos )
	{
...
float CEOSAIUnitTemplate2::GetUpgradeMoneyCost( CString strUnitsubset )
{
	CString strUpgrade = GetUnitsubsetUpgradeTo( strUnitsubset );
	CEOSAIUnitTemplate2* pUpgrade = m_pAIGameRules->GetAIUnitTemplate( strUpgrade );
	if( pUpgrade )
	{
...
float CEOSAIUnitTemplate2::GetUpgradeIronCost( CString strUnitsubset )
{
	CString strUpgrade = GetUnitsubsetUpgradeTo( strUnitsubset );
	CEOSAIUnitTemplate2* pUpgrade = m_pAIGameRules->GetAIUnitTemplate( strUpgrade );
	if( pUpgrade )
...
float CEOSAIUnitTemplate2::GetUpgradeTime( CString strUnitsubset )
{
	CString strUpgrade = GetUnitsubsetUpgradeTo( strUnitsubset );
	CEOSAIUnitTemplate2* pUpgrade = m_pAIGameRules->GetAIUnitTemplate( strUpgrade );
	if( pUpgrade )
...
void  CEOSAIUnitTemplate2::RemoveUnitsubsetUpgradeTo( CString strUnitsubset )
{
	POSITION pos = m_UpgradeToList.GetHeadPosition();
	while( pos )
	{
...
CEOSAIUnitTemplate2* CEOSAIUnitTemplate2::GetUpgradesFrom() // this doesn't always work right since multiple units can upgrade to this one
{
	CString strUnitTemplate = GetInternalName();
	POSITION pos = m_pAIGameRules->GetAIUnitTemplates()->GetHeadPosition();
	while( pos )
	{
		CEOSAIUnitTemplate2* pOtherTemplate = m_pAIGameRules->GetAIUnitTemplates()->GetNext( pos );
...
// Unit Tags
//
void  CEOSAIUnitTemplate2::AddUnitTag( CString strTag )
{
...
void  CEOSAIUnitTemplate2::RemoveUnitTag( CString strTag )
{
	POSITION pos = m_UnitTagList.GetHeadPosition();
	while( pos )
	{
...
bool  CEOSAIUnitTemplate2::UnitTagExists( CString strTag )
{
	/*
	POSITION pos = m_UnitTagList.GetHeadPosition();
	while( pos )
...
CUnitTag* CEOSAIUnitTemplate2::GetUnitTag( CString strTag )
{
	POSITION pos = m_UnitTagList.GetHeadPosition();
	while( pos )
	{
...
/*
CList< CEOSAIStringAndLong* >*  CEOSAIUnitTemplate2::GetTargetPriorityTags()
{
	return &m_TargetPriorityTagList;
}
*/
/*
long  CEOSAIUnitTemplate2::GetTargetPriorityTag( CString str )
{
...
//
/*
EnumMovementType CEOSAIUnitTemplate2::GetMovementType()
{
...
void CEOSAIUnitTemplate2::SetMovementUnitTypeByExternalName( CString strExternalName )
{
	// Update the MovementDescription object
...
void CEOSAIUnitTemplate2::SetMovementUnitType( long iMovementUnitType )
{
...
CEOSAIMovementUnitType* CEOSAIUnitTemplate2::GetMovementUnitType()
{
	return m_pAIGameRules->GetMovementUnitType( m_iMovementUnitType );
}

long CEOSAIUnitTemplate2::GetMovementUnitTypeLong()
{
	return m_iMovementUnitType;
}

CString CEOSAIUnitTemplate2::GetMovementUnitTypeString() //{ return m_strMovementUnitType; }
{
	CEOSAIMovementUnitType* pType = m_pAIGameRules->GetMovementUnitType( m_iMovementUnitType );
	if( pType )
	{
...
long CEOSAIUnitTemplate2::GetNormalTerrain()
{
...
void CEOSAIUnitTemplate2::SetCombatUnitType( long iCombatUnitType )
{
...
void CEOSAIUnitTemplate2::SetCombatUnitTypeByExternalName( CString strUnitType )
{
...
CString CEOSAIUnitTemplate2::GetCombatUnitTypeString()
{
...
long CEOSAIUnitTemplate2::GetCombatUnitTypeWhenLandedOrDocked()
{
...
bool  CEOSAIUnitTemplate2::CanBlockAndBeBlocked()
{
	//CCombatUnitType* pCombatUnitType = m_pUnitset->GetCombatUnitType( m_strCombatUnitType );	
	CEOSAICombatUnitType* pCombatUnitType = m_pAIGameRules->GetCombatUnitType( m_iCombatUnitType );
	ASSERT( pCombatUnitType );
...
long  CEOSAIUnitTemplate2::GetDrawOrder()
{
	CEOSAICombatUnitType* pCombatUnitType = m_pAIGameRules->GetCombatUnitType( m_iCombatUnitType );	
	//ASSERT( pCombatUnitType );
...
bool  CEOSAIUnitTemplate2::IsGroundUnit()
{
...
bool  CEOSAIUnitTemplate2::IsAirUnit() //{ return m_MovementDescription.GetMovementType() == EOSAIEnumMovementType3_Air; }
{
	CEOSAIMovementUnitType* pType = m_pAIGameRules->GetMovementUnitType( GetMovementUnitTypeLong() );
	if( pType )
	{
...
bool  CEOSAIUnitTemplate2::IsSeaUnit() //{ return m_MovementDescription.GetMovementType() == EOSAIEnumMovementType3_Air; }
{
	CEOSAIMovementUnitType* pType = m_pAIGameRules->GetMovementUnitType( GetMovementUnitTypeLong() );
	if( pType )
	{
...
bool  CEOSAIUnitTemplate2::CanContain( CEOSAIPoiObject2* pAIPoiObject )
{
	...
	if( pAIUnitGroup )
	{
		...
		while( pos )
		{
			...
			CEOSAIPoiObject2* pPoiObject = pLink->GetPtr();
			// Recursive
...
bool  CEOSAIUnitTemplate2::CanContain( CEOSAIUnitTemplate2* pAITemplate )
{
...
bool  CEOSAIUnitTemplate2::CanContainGroundUnits()
{
	ASSERT( m_pAIGameRules );
	CList< CEOSAIUnitTemplate2* >  UnitTemplateList;
	POSITION pos = m_CanContainUnitTagList.GetHeadPosition();
	while( pos )
	{
		...
		while( pos2 )
		{
			CEOSAIUnitTemplate2* pUnitTemplate = UnitTemplateList.GetNext( pos2 );
...
long  CEOSAIUnitTemplate2::GetNumberOfGroundUnitsThatICanContain()
{
...
bool  CEOSAIUnitTemplate2::CanContainAirUnits()
{
	...
	while( pos )
	{
		...
		while( pos2 )
		{
			CEOSAIUnitTemplate2* pAIUnitTemplate = UnitTemplateList.GetNext( pos2 );
...
bool  CEOSAIUnitTemplate2::CanLaunchAirUnits()
{
	if( CanContainUnits() == false ) return false;
...
long  CEOSAIUnitTemplate2::GetNumberOfAirUnitsThatICanContain()
{
...
*/
float CEOSAIUnitTemplate2::GetViewRange( CEOSAIPoiObject2* pPoi )
{
	/*
	CEOSAIPoiMobile2* pOtherPoiMobile = dynamic_cast< CEOSAIUnit2* >( pPoi );
	if( pOtherPoiMobile )
	{
		CEOSAIUnit2* pOtherUnit = dynamic_cast< CEOSAIUnit2* >( pPoi );
		if( pOtherUnit )
		{
			CEOSAIUnitTemplate2* pOtherUnitTemplate = pOtherUnit->GetAIUnitTemplate();
...
float CEOSAIUnitTemplate2::GetViewRange( CEOSAIUnitTemplate2* pUnitTemplate )
{
	/*
	POSITION pos = m_ViewRangeList.GetHeadPosition();
	while( pos )
...
bool CEOSAIUnitTemplate2::CanAttack( CEOSAIPoiObject2* pTarget )
{
	if( CanCapture( pTarget ) || CanDegrade( pTarget ) || CanDestroy( pTarget ) ) return true;
	return false;
}

bool CEOSAIUnitTemplate2::CanDestroy( CEOSAIPoiObject2* pTarget )
{
	CEOSAIAirfield2* pAIAirfield = dynamic_cast< CEOSAIAirfield2* >( pTarget );
	if( pAIAirfield )
	{
		return CanDestroyAirfields();
	}
	// The ability to attack PoiMobile depends on the attacker's specific combat capabilities
	CEOSAIPoiObject2* pTargetPoiObject = dynamic_cast< CEOSAIPoiObject2* >( pTarget );
	CEOSAIPoiMobile2* pTargetPoiMobile = dynamic_cast< CEOSAIPoiMobile2* >( pTarget );
	if( pTargetPoiMobile )
	{
...
bool  CEOSAIUnitTemplate2::OneAttackPerLandingVs( CEOSAIPoiObject2* pTarget )
{
	/*
...
bool  CEOSAIUnitTemplate2::CanCapture( CEOSAIPoiObject2* pPoiObject )
{
	if( dynamic_cast< CEOSAICity2* >( pPoiObject ) )
	{
		return CanCaptureCities();
	}
	if( dynamic_cast< CEOSAIResource2* >( pPoiObject ) )
	{
		CEOSAIResource2* pResource = dynamic_cast< CEOSAIResource2* >( pPoiObject );
	...
	if( dynamic_cast< CEOSAIAirfield2* >( pPoiObject ) )
	{
...
bool  CEOSAIUnitTemplate2::CanCapture( EnumAIPoiObjectType enumPoiObjectType )
{
...
bool  CEOSAIUnitTemplate2::CanDegrade( CEOSAIPoiObject2* pPoiObject )
{
	if( dynamic_cast< CEOSAICity2* >( pPoiObject ) )
	{
...
/*
bool  CEOSAIUnitTemplate2::AttackMethodIsBombingVs( CPoiObject* pTarget )
{
...
// UnitTag Containment
//
void  CEOSAIUnitTemplate2::AddCanContainUnitTag( CString strTag )
{
	//CUnitTag* pUnitTag = new CUnitTag( strTag );
...
void  CEOSAIUnitTemplate2::RemoveCanContainUnitTag( CString strTag )
{
	POSITION pos = m_CanContainUnitTagList.GetHeadPosition();
	while( pos )
	{
...
bool  CEOSAIUnitTemplate2::CanContainUnitTagExists( CString strTag )
{
	/*
	POSITION pos = m_CanContainUnitTagList.GetHeadPosition();
	while( pos )
...
/*
void  CEOSAIUnitTemplate2::SetCanContain( CString strClassName )
{
	m_UnitsThatICanCarry.AddHead( strClassName );
}
*/
/*
void CEOSAIUnitTemplate2::GetPrereqTechList_Top( CStringList* pPrereqTechList )
{
...
void CEOSAIUnitTemplate2::GetPrereqTechList_All( CStringList* pPrereqTechList )
{
...
void CEOSAIUnitTemplate2::CalculatePrereqTechCost2()
{
...
long CEOSAIUnitTemplate2::GetPrereqTechCost()
{
	CStringList  PrereqTechList;
	GetPrereqTechList_All( &PrereqTechList );
...
*/
bool CEOSAIUnitTemplate2::CityMustHave( CString strBuilding )
{
...
void CEOSAIUnitTemplate2::RemoveCityMustHave( CString strBuilding )
{
	POSITION pos = m_CityMustHaveList.GetHeadPosition();
	while( pos )
	{
...
/*
void  CEOSAIUnitTemplate2::OnSelectSoundFile( CString str )
{
...
float CEOSAIUnitTemplate2::GetProductionAndConsumptionPerTurnAndMove( CString strResource )
{
	return
...
void CEOSAIUnitTemplate2::InvokeProductionAndConsumptionPerTurn( CString strResource, float fValue )
{
	//if( fValue < 0.0f ){ fValue = 0.0f; }
	POSITION pos = m_ProductionAndConsumptionPerTurnList.GetHeadPosition();
	while( pos )
	{
		CEOSAIStringAndFloat* p = m_ProductionAndConsumptionPerTurnList.GetNext( pos );
	...
	CEOSAIStringAndFloat* p = new CEOSAIStringAndFloat( strResource, fValue );
	m_ProductionAndConsumptionPerTurnList.AddTail( p );
}

void CEOSAIUnitTemplate2::RemoveProductionAndConsumptionPerTurn( CString strResource )
{
	POSITION pos = m_ProductionAndConsumptionPerTurnList.GetHeadPosition();
	while( pos )
	{
...
float CEOSAIUnitTemplate2::GetProductionAndConsumptionPerTurn( CString strResource )
{
	POSITION pos = m_ProductionAndConsumptionPerTurnList.GetHeadPosition();
	while( pos )
	{
...
CEOSAIStringAndFloat*  CEOSAIUnitTemplate2::GetProductionAndConsumptionPerTurnObj( CString strResource )
{
	POSITION pos = m_ProductionAndConsumptionPerTurnList.GetHeadPosition();
	while( pos )
	{
...
void CEOSAIUnitTemplate2::InvokeProductionAndConsumptionPerMove( CString strResource, float fValue )
{
	//if( fValue < 0.0f ){ fValue = 0.0f; }
	POSITION pos = m_ProductionAndConsumptionPerMoveList.GetHeadPosition();
	while( pos )
	{
		CEOSAIStringAndFloat* p = m_ProductionAndConsumptionPerMoveList.GetNext( pos );
		if( p->m_strValue == strResource )
		{
			p->m_fValue = fValue;
			return;
...
void CEOSAIUnitTemplate2::RemoveProductionAndConsumptionPerMove( CString strResource )
{
	POSITION pos = m_ProductionAndConsumptionPerMoveList.GetHeadPosition();
	while( pos )
	{
...
float CEOSAIUnitTemplate2::GetProductionAndConsumptionPerMove( CString strResource )
{
	POSITION pos = m_ProductionAndConsumptionPerMoveList.GetHeadPosition();
	while( pos )
	{
...
CEOSAIStringAndFloat*  CEOSAIUnitTemplate2::GetProductionAndConsumptionPerMoveObj( CString strResource )
{
	POSITION pos = m_ProductionAndConsumptionPerMoveList.GetHeadPosition();
	while( pos )
	{
...
/*
float CEOSAIUnitTemplate2::GetOilConsumption()
{
	return 0.0f;
}
*/
/*
float CEOSAIUnitTemplate2::AmountOfFoodNeededThisTurn()
{
	return 0.0f;
}
*/
/*
void CEOSAIUnitTemplate2::PlayOnSelectSound()
{
	m_pUnitTemplateImage->PlayOnSelectSound();
}
*/
bool  CEOSAIUnitTemplate2::CanDegradeCities()
{
...
bool  CEOSAIUnitTemplate2::CanTargetCities()
{
	if( CanKillPopulation() ) return true;
	if( CanDestroyBuildings() ) return true;
...
// Refugees
float CEOSAIUnitTemplate2::GetNumberOfRefugeesOnHit()
{
	//return 2.0f*m_fKillPopulationDeaths;//m_fNumberOfRefugeesOnHit;
	return m_fNumberOfRefugeesOnHit;
}

void  CEOSAIUnitTemplate2::SetNumberOfRefugeesOnHit( float f )
{
	m_fNumberOfRefugeesOnHit = f;
}

/*
void  CEOSAIUnitTemplate2::DeleteUnitTemplateCombatAnimation( CUnitTemplateCombatAnimationDesc* pAnim )
{
	POSITION pos = m_UnitTemplateCombatAnimationDescs.GetHeadPosition();
	while( pos )
	{
...
*/
/*
void  CEOSAIUnitTemplate2::OnCombatVsGroundSound( CString str )
{
	CBCSound* pSound = new CBCSound();
	if( pSound )
	{
...
void CEOSAIUnitTemplate2::PlayOnCombatVsGroundSound()
{
...
void CEOSAIUnitTemplate2::OnCombatVsGroundAnimation( CString str )
{
	// Do something here
}
*/

//float CEOSAIUnitTemplate2::GetMovementRangeAssumingIAttack()
// Aircraft want to return, Missiles/Kamikazis do not
float CEOSAIUnitTemplate2::GetMovementRangeForAttack()
{
...
/*
float CEOSAIUnitTemplate2::GetMovementRangeAssumingIWantToReturn()
{
	float fMovementRange = GetMovementRange();
...
CEOSAIAttackVs2*  CEOSAIUnitTemplate2::GetAttackVs( CEOSAIPoiObject2* pTarget, bool bIsLandedOrDocked )
{
	if( dynamic_cast< CEOSAICity2* >( pTarget ) ||
		dynamic_cast< CEOSAIResource2* >( pTarget ) ||
		dynamic_cast< CEOSAIFortification* >( pTarget ) ||
		dynamic_cast< CEOSAIAirfield2* >( pTarget ) )
	{
...
float CEOSAIUnitTemplate2::GetAttackRangeMaximum()
{
...
*/
CEOSAIAttackVs2* CEOSAIUnitTemplate2::GetAttackVsCombatUnitType( long iCombatUnitType )
{
	POSITION pos = m_AttackVsList.GetHeadPosition();
	while( pos )
	{
...
/*
CEOSAIAttackVs2* CEOSAIUnitTemplate2::GetAttackVs( CString strCombatUnitType )
{
	POSITION pos = m_AttackVsList.GetHeadPosition();
	while( pos )
	{
...
*/
CEOSAIAttackVs2* CEOSAIUnitTemplate2::GetAttackVs( EnumAIPoiObjectType ePoiObjectType, CEOSAIUnitTemplate2* pTargetUnitTemplate, bool bIsLandedOrDocked )
{
...
/*
CEOSAIAttackVs2* CEOSAIUnitTemplate2::GetAttackVs( EnumPoiObjectType eUnitType )
{
	POSITION pos = m_AttackVsList.GetHeadPosition();
	while( pos )
	{
...
*/
void CEOSAIUnitTemplate2::DeleteAttackVs( CEOSAIAttackVs2* pAttackVs )
{
	POSITION pos = m_AttackVsList.GetHeadPosition();
	while( pos )
	{
...
float CEOSAIUnitTemplate2::GetAttackToHitVs( EnumAIPoiObjectType ePoiObjectType, CEOSAIUnitTemplate2* pTargetUnitTemplate, bool bIsLandedOrDocked )
{
...
//float CEOSAIUnitTemplate2::GetAttackToHitVs( CPoiObject* pTarget, Enum_Prone eDefendersProneState )
float CEOSAIUnitTemplate2::GetAttackToHitVs( CEOSAIPoiObject2* pTarget, bool bIsLandedOrDocked )
{
...
float CEOSAIUnitTemplate2::GetAttackToHitVs( CEOSAIUnitTemplate2* pTarget )
{
...
float CEOSAIUnitTemplate2::GetAttackToHitVs( long iCombatUnitType )
{
	CEOSAIAttackVs2* pAttackVs = GetAttackVsCombatUnitType( iCombatUnitType );
	if( pAttackVs )
	{
...
/*
float CEOSAIUnitTemplate2::GetAttackToHitVs( CString strCombatUnitType )
{
...
*/
/*
float CEOSAIUnitTemplate2::GetAttackToHitVsPoiObjectType( EnumPoiObjectType ePoiObjectType )
{
...
// Attack Damage
//long CEOSAIUnitTemplate2::GetAttackDamageVs( CPoiObject* pTarget, Enum_Prone eDefendersProneState )
long CEOSAIUnitTemplate2::GetAttackDamageVs( CEOSAIPoiObject2* pTarget, bool bIsLandedOrDocked )
{
	if( dynamic_cast< CEOSAICity2* >( pTarget ) )
	{
	...
	if( dynamic_cast< CEOSAIResource2* >( pTarget ) )
	{
	...
	if( dynamic_cast< CEOSAIAirfield2* >( pTarget ) )
	{
...
long  CEOSAIUnitTemplate2::GetAttackDamageVs( CEOSAIUnitTemplate2* pTarget )
{
	//CString strTargetCombatUnitType = pTarget->GetCombatUnitTypeString();
...
long  CEOSAIUnitTemplate2::GetAttackDamageVs( long iTargetCombatUnitType )
{
...
/*
long  CEOSAIUnitTemplate2::GetAttackDamageVs( CString strTargetCombatUnitType )
{
...
*/
float CEOSAIUnitTemplate2::GetAttackRangeVs( CEOSAIUnitTemplate2* pTarget )
{
	//CString strTargetCombatUnitType = pTarget->GetCombatUnitTypeString();
	//CEOSAIAttackVs2* pAttackVs = GetAttackVs( strTargetCombatUnitType );
	long iTargetCombatUnitType = pTarget->GetCombatUnitTypeLong();
...
/*
long CEOSAIUnitTemplate2::GetAttackDamageVsPoiObjectType( EnumPoiObjectType ePoiObjectType )
{
	if( ePoiObjectType.IsUnit() )
	{
		if( ePoiObjectType == EnumPoiObjectType::enum_Soft )
...
/*
float CEOSAIUnitTemplate2::GetAttackToHitVsPoiObject( CPoiObject* pPoiObject, Enum_Prone eDefendersProneState )
{
...
*/
/*
CUnitTemplateCombatAnimationImage* CEOSAIUnitTemplate2::GetCombatAnimationDescription( CPoi* pTarget )
{
...
*/
float CEOSAIUnitTemplate2::GetDefenseValueForNormalTerrain()
{
...
float CEOSAIUnitTemplate2::GetDefenseValue( long iTerrainType )
{
...
float CEOSAIUnitTemplate2::GetCurrentDefense( long iTerrain, bool bEntrenched, bool bInFort, bool bIsLandedOrDocked )
{
...
float CEOSAIUnitTemplate2::GetDefenseEntrenchedBonusPercent()
{
...
float CEOSAIUnitTemplate2::GetDefenseEntrenchedBonus()
{
	if( m_pCombatUnitType == NULL )
	{
		m_pCombatUnitType = m_pAIGameRules->GetCombatUnitType( m_iCombatUnitType );
...
float CEOSAIUnitTemplate2::GetDefenseMult( long iTerrain )
{
...
/*
float CEOSAIUnitTemplate2::GetLandedOrDockedDefenseValuePercent()
{
	CCombatUnitType* pType = m_pUnitset->GetCombatUnitType( m_strCombatUnitType );
...
*/
/*
float CEOSAIUnitTemplate2::GetLandedOrDockedDefenseValue()
{
	/*
	CCombatUnitType* pType = m_pUnitset->GetCombatUnitType( m_strCombatUnitType );
...
bool CEOSAIUnitTemplate2::IsOfType( EOSAIEnumTypeOfUnit eTypeOfUnit )
{
...
/*
float CEOSAIUnitTemplate2::GetAntiUnitCombat( CString strCombatUnitType )
{
	CEOSAIAttackVs2* pAttackVs = GetAttackVs( strCombatUnitType );
	ASSERT( pAttackVs );
	if( pAttackVs )
...
void  CEOSAIUnitTemplate2::GetAIJobCapability( CEOSAIJobCapability* pAIJobCapability )
{
...
CEOSAIUnit2CombatCapability* CEOSAIUnitTemplate2::GetAIUnitCombatCapability()
{
	ASSERT( g_pEOSAICommonData );
	return &m_AIUnitCombatCapability;
}

float CEOSAIUnitTemplate2::GetExplorationCapability()
{
...
float CEOSAIUnitTemplate2::GetSightingCapability()
{
	// Airplanes are better than ground units, sea units because they can fly over
	//   ground and water.  However, they have a limited range.  
	//   I'm going to call this a wash and ignore those effects.
...
float CEOSAIUnitTemplate2::GetGroundCitResHunterCapacity()
{
...
float CEOSAIUnitTemplate2::GetStrategicBombingCapability()
{
...
/*
float CEOSAIUnitTemplate2::GetTacticalBombingCapability()
{
...
*/
float  CEOSAIUnitTemplate2::GetAirEscortCapability()
{
	return 0.0f;
	ASSERT( false );
	/*
...
float  CEOSAIUnitTemplate2::GetAntiAirCapability()
{
	/*
	POSITION pos = GetAttackVsList()->GetHeadPosition();
	while( pos )
...
float CEOSAIUnitTemplate2::GetSubmarineCapability()
{
	if( this->IsSubmarine() )
	{
		return 1.0f;
...
float  CEOSAIUnitTemplate2::GetAntiSubmarineCapability()
{
	return 0.0f;
	ASSERT( false );
...
float  CEOSAIUnitTemplate2::GetLandCitResHunterCapability()
{
...
float  CEOSAIUnitTemplate2::GetBombardmentCapability()
{
	//return GetBombardRange() * GetBombardValue() / 15.0f;
	return 0.0f;
}
/*
float  CEOSAIUnitTemplate2::GetOffensiveGroundCapability()
{
	if( IsGroundUnit() )
	{
		return GetAttackVsSoft()->GetToHit() * 
...
*/
/*
float  CEOSAIUnitTemplate2::GetDefensiveGroundCapability()
{
	if( IsGroundUnit() )
	{
		/-*
...
*/
float  CEOSAIUnitTemplate2::GetInvasionDefense()
{
	return 0.0f;
	ASSERT( false );
...
float  CEOSAIUnitTemplate2::GetSeaResourceHunterCapability()
{
...
float  CEOSAIUnitTemplate2::GetSeaSupremacyCapability()
{
	return 0.0f;
	ASSERT( false );
	/*
...
float  CEOSAIUnitTemplate2::GetShoreBombardmentCapability()
{
	if( this->IsSeaUnit() )
	{
		//return GetBombardRange() * GetBombardValue() / 15.0f;
...
float  CEOSAIUnitTemplate2::GetAirfieldBuilderCapacity()
{
...
float  CEOSAIUnitTemplate2::GetGroundTransportCapability()
{
...
void CEOSAIUnitTemplate2::GetUnitStrength( CString* pstrUnitType, float* pfValue )
{
	*pstrUnitType = GetCombatUnitTypeString();
	*pfValue = GetMaxHP() * GetDefenseValueForNormalTerrain();
}

float CEOSAIUnitTemplate2::GetExpectedHPDamage( CEOSAIUnit2* pTargetUnit, bool bUseNormalTerrainIfBetterThanCurrentDefense )
{
...
float CEOSAIUnitTemplate2::GetExpectedHPDamage( CEOSAIUnitTemplate2* pTargetUnitTemplate )
{
...
/*
float CEOSAIUnitTemplate2::GetUnitStrengthSoft() // return 0.0 unless this is a soft unit (I need to know who my targets will be)
{
	if( IsSoftGroundUnit() == false ) return 0.0f;
	return GetMaxHP() * GetDefenseValueForNormalTerrain();
}

float CEOSAIUnitTemplate2::GetUnitStrengthArmor()
{
	if( IsArmor() == false ) return 0.0f;
	return GetMaxHP() * GetDefenseValueForNormalTerrain();
}

float CEOSAIUnitTemplate2::GetUnitStrengthAircraft()
{
	if( IsAircraft() == false ) return 0.0f;
	return GetMaxHP() * GetDefenseValueForNormalTerrain();
}

float CEOSAIUnitTemplate2::GetUnitStrengthMissile()
{
	if( IsMissile() == false ) return 0.0f;
	return GetMaxHP() * GetDefenseValueForNormalTerrain();
}

float CEOSAIUnitTemplate2::GetUnitStrengthShip()
{
	if( IsShip() == false ) return 0.0f;
	return GetMaxHP() * GetDefenseValueForNormalTerrain();
}

float CEOSAIUnitTemplate2::GetUnitStrengthSubmarine()
{
...
float CEOSAIUnitTemplate2::GetAICombatSignificance()
{
	return m_AIUnitCombatCapability.GetCombatSignificance();
}
/*
float CEOSAIUnitTemplate2::GetAIPowerValue()
{
...
*/
CEOSAIStringAndFloatSet  CEOSAIUnitTemplate2::GetCombatPowerVsUnitTypes()
{
	CEOSAIStringAndFloatSet  CombatPowerVsUnitTypes;
	POSITION pos = m_AttackVsList.GetHeadPosition();
	while( pos )
	{
		CEOSAIAttackVs2* pAttackVs = m_AttackVsList.GetNext( pos );
...
float CEOSAIUnitTemplate2::GetProductionAndIronCost1()
{
	return GetProductionCost() + GetIronCost();
}

// Multiply the Iron, Oil costs
float CEOSAIUnitTemplate2::GetProductionAndIronCost( CEOSAICitResValueMultiplier* pCitResValueMultiplier )
{
	return
...
/*
void  CEOSAIUnitTemplate2::GetCombatPowerVsUnitTypes( CEOSAIStringAndFloatSet* pSet )
{
	pSet->Clear();
	//
	POSITION pos = m_AttackVsList.GetHeadPosition();
...
float CEOSAIUnitTemplate2::GetAICombatVsSoft() // How well can this unit attack my Soft units?
{
...
float CEOSAIUnitTemplate2::GetAICombatVsArmor()
{
...
float CEOSAIUnitTemplate2::GetAICombatVsAircraft()
{
...
float CEOSAIUnitTemplate2::GetAICombatVsMissile()
{
...
float CEOSAIUnitTemplate2::GetAICombatVsShip()
{
...
float CEOSAIUnitTemplate2::GetAICombatVsSubmarine()
{
...
/*
float  CEOSAIUnitTemplate2::GetTradeCapability()
{
	return 1.0f;
}
*/
...
/*
CString CEOSAIUnitTemplate2::GetHtmlDesc()
{
...
*/
/*
CString CEOSAIUnitTemplate2::RowHtml( CString strColumn1, 
							    CString strLink,
							    CString strColumn2,
							    long iRowNumber )
{
